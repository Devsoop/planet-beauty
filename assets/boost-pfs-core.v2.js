...
var BoostPFS = (function (t) {
    ...
    var h = function () {
      ...
      g = {
        ...
        buildProductItemUrlWithVariant: function (t) {
          var e =
            t.split_product && t.variant_id ? "?variant=" + t.variant_id : "";
          ...
          var a = function () {
            ...
            if (
              ...
              t.removeClass("boost-pfs-filter-stick"),
                ...
                i()("body").removeClass("boost-pfs-filter-stick-body"),
                i()("body").removeClass(h);
              var b = o.a.getSettingValue("general.stickyFixTopPos")
                ? f - p - c
                : f - c - d;
              t.css({
                position: "absolute",
        ...
        (n = [
          ...
          },
          {
            ...
            value: function () {
              ...
              var i = l.a.reBuildUrlBaseOnLocale(
                "/search?" +
                  s.a.searchTermKey +
                  "=" +
  ...
  189: function (t, e, n) {
    ...
    (window.BoostPFSFilterCallback = n(8).default.BoostPFSFilterCallback),
      (window.BoostPFSInstantSearchCallback =
        n(82).default.BoostPFSInstantSearchCallback),
      (t.exports = r);
  },
  2: function (t, e, n) {
    "use strict";
  ...
  61: function (t, e, n) {
        ...
        (n = [
          ...
          },
          {
            ...
            value: function () {
              this._catchError(),
                this.totalProduct > 0 &&
                  ("incollection_search" === l.a.queryParams.event_type &&
                    u.a.showFilterTree(),
          ...
          },
          {
            ...
            value: function (t) {
              if (t && t.page && t.productId && t.position && t.url) {
                ...
                if (
                  (r && (e.page = r), Navigation.buildAddressBarUrl(e) != t.url)
                )
                  return;
                if (
                  o.a.getSettingValue("general.paginationType") ==
            ...
            value: function () {
              if (u.a.isNoFilterResult(this.totalProduct, this.eventType)) {
                ...
                u.a.checkExistFilterOptionParam()
                  ...
                  : u.a.isSearchPage()
                  ? ((t = a.a.search.resultEmpty.replace(
                      /{{ terms }}/g,
                      "<strong>" +
          ...
          },
          {
            ...
            value: function () {
              if (!i()(this.selector.searchWrapper).length) {
                ...
                t.length &&
                  (t.val(u.a.stripHtml(l.a.queryParams.q) || ""),
                  (this.searchValue = u.a.stripHtml(l.a.queryParams.q) || ""),
                  this.searchValue && i()(this.selector.clearButton).show());
              }
            },
          },
          {
    ...
    var Zn = (function (t) {
      ...
      function s(t) {
        ...
        return (
          ...
          (e.filterTree.mobileButton = Qn(e)),
          (e.isCollapsed = !0),
            ...
            value: function () {
              this.isCollapsed ||
                this.filterTree.filterOptions.forEach(function (t) {
                  t.displayType != qn.a.DisplayType.BOX ||
                    t.isCollapsed ||
    ...
    var or = (function (t) {
      ...
      function s(t) {
        ...
        return (
          ...
          ((e = l.call(this)).filterTree = t),
          (e.filterTree.desktopButton = rr(e)),
          (e.isCollapsed = !0),
                  ...
                  if (t && t.type && t.label) {
                    ...
                    o.a.getSettingValue("general.enable3rdCurrencySupport") &&
                      ...
                      (this.filterOptionLabel = u.a.stripHtml(
                        t.type &&
                          this.filterTreeType == vr.FilterTreeType.VERTICAL
                          ? t.type + ": "
                          : ""
                      )),
            ...
            value: function () {
              ...
              switch (this.clearType) {
                case c.ClearType.CLEAR_OPTION_VALUES:
                  var e = this.parent;
                  if (
                    e.displayType == qn.a.DisplayType.MULTI_LEVEL_COLLECTIONS
                  ) {
      ...
      function c(t, e) {
        ...
        return (
          ...
          ((n = s.call(this)).filterTreeType =
            t || vr.FilterTreeType.HORIZONTAL),
        ...
        (n = [
          {
            ...
            value: function () {
              this.label =
                this.filterTreeType == vr.FilterTreeType.HORIZONTAL &&
          ...
          },
          {
            ...
            value: function () {
              ...
              this.parent.displayType == qn.a.DisplayType.MULTI_LEVEL_TAG &&
          ...
          },
          {
            ...
            value: function () {
              var t = this.filterOption ? this.filterOption : this.parent,
                ...
                n =
                  t.filterType == qn.a.FilterType.REVIEW_RATINGS &&
                  t.showExactRating,
                r =
                  t.filterType == qn.a.FilterType.COLLECTION &&
            ...
            value: function () {
              ...
              if (
                ...
                (this.docCount > 0 ||
                  ...
                  (this.parent.filterType == qn.a.FilterType.REVIEW_RATINGS &&
          ...
          },
          {
            ...
            value: function (t) {
              t && t.preventDefault(),
                this.isDisabled() ||
                  (this.requestInstantly ||
                  this.parent.filterType == qn.a.FilterType.COLLECTION
                    ? this.onApplyFilter()
                    : this.onSelectFilter());
            },
          },
              ...
              (this.isSelected = !this.isSelected),
                ...
                this.isSelected
                  ...
                  : this.$element
                      ...
                      .removeAttr("aria-checked"),
                this.isSelected &&
                  this.parent.selectType == qn.a.SelectType.SINGLE &&
            ...
            value: function () {
              var t = this,
                ...
                o =
                  "all" == this.handle &&
                  0 == this.docCount &&
                  e == qn.a.FilterType.COLLECTION;
              if (
                this.docCount > 0 ||
                this.parent.keepValuesStatic ||
                n == qn.a.DisplayType.RANGE ||
                o
              ) {
                l.a.internalClick = !0;
                var a = "";
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: "bindEvents",
            value: function () {
              zr(Qr(o.prototype), "bindEvents", this).call(this),
                this.setBoxItemSize();
            },
          },
          {
            ...
            value: function () {
              this.buildSwatchSettings() ||
                ...
                (this.swatchBorder = ["white", "#FFFFFF"].includes(
                  ...
                  ? "has-border"
                  : ""),
                ei(ii(a.prototype), "render", this).call(this);
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.adaLabel += ". " + t),
                ...
                ci(fi(o.prototype), "render", this).call(this);
            },
          },
        ]) && si(e.prototype, n),
        r && si(e, r),
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: "setData",
            value: function (t) {
              mi(Si(a.prototype), "setData", this).call(this, t),
                (this.tags = t.tags);
            },
          },
        ]) && gi(e.prototype, n),
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: "setData",
            value: function (t) {
              _i(Ei(o.prototype), "setData", this).call(this, t),
                null != t.min &&
                  null != t.max &&
                  ((this.min = t.min),
                  (this.max = t.max),
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                return (
                  this.parent.displayType != qn.a.DisplayType.RANGE &&
                  (this.parent.showMoreType == qn.a.ShowMoreType.VIEWMORE ||
                    this.parent.showMoreType ==
                      qn.a.ShowMoreType.VIEWMORE_SCROLLBAR)
                );
              },
            },
            {
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: "isRender",
            value: function () {
              if (this.parent.filterTreeType == vr.FilterTreeType.HORIZONTAL)
                return !1;
              var t =
                ...
                n = [
                  qn.a.FilterType.PRICE,
                  qn.a.FilterType.PERCENT_SALE,
                  qn.a.FilterType.STOCK,
                ],
                r = [
                  qn.a.DisplayType.RANGE,
                  qn.a.DisplayType.MULTI_LEVEL_TAG,
                  qn.a.DisplayType.MULTI_LEVEL_COLLECTIONS,
                ],
                i =
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var r = [qn.a.DisplayType.RANGE],
                  i = [
                    qn.a.FilterType.REVIEW_RATINGS,
                    qn.a.FilterType.STOCK,
                    qn.a.FilterType.PERCENT_SALE,
                    qn.a.FilterType.PRICE,
                    qn.a.FilterType.VARIANTS_PRICE,
                  ],
                  a =
                    n == qn.a.ShowMoreType.SCROLLBAR ||
                    n == qn.a.ShowMoreType.VIEWMORE_SCROLLBAR,
                  l = u.a.isMobile(),
                  s =
                    (l &&
                      o.a.getSettingValue(
          ...
          so(
            ...
            [
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this;
                  co(yo(n.prototype), "setData", this).call(this, t),
            ...
            },
            {
              ...
              value: function (t) {
                t && t.preventDefault(),
                  ...
                  this.children &&
                    this.children.length > 0 &&
                    go.setLevelOpenStateData(this, !0),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    this.isSelected ||
                    (this.filterOption.selectType == qn.a.SelectType.SINGLE &&
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  (this.value = t.tag),
                    ...
                    this.filterOption.displayTypeItem ==
                      qn.a.DisplayType.SWATCH && this.setSwatchData(),
                    (this.children = []),
                    Array.isArray(t.subTags) &&
                      t.subTags.forEach(function (t) {
                        if (t.tag) {
                ...
                (this.$clickElement = this.parent.$filterOptionTitleElement),
                  ...
                  this.filterTreeType == vr.FilterTreeType.VERTICAL
                    ...
                    : (this.$clickElement.on(
                      ...
                      this.parent.filterOptionId == No &&
                        ((No = ""), this.onToggleHorizontal())),
        ...
        (n = [
          {
            key: "init",
            value: function () {
              (this.collapse = new Wo(this.filterTreeType)),
                this.addComponent(this.collapse),
                (this.clearButton = new _r(
                  this.filterTreeType,
                  _r.ClearType.CLEAR_OPTION_VALUES
                )),
                this.addComponent(this.clearButton),
                (this.applyButton = new Lr(
                  this.filterTreeType,
                  Lr.ApplyType.APPLY_OPTION_VALUES
                )),
                this.addComponent(this.applyButton),
                (this.viewMore = new ji(this.filterTreeType)),
                this.addComponent(this.viewMore),
                (this.scrollbar = new io()),
                this.addComponent(this.scrollbar),
                (this.searchBox = new Wi()),
                this.addComponent(this.searchBox),
                (this.filterTooltip = new Qi(this.tooltip)),
              ...
              if (this.status == qn.a.Status.ACTIVE) {
                var t = o.a.getSettingValue("general.showSingleOption"),
                  ...
                  n =
                    this.displayType ==
                      qn.a.DisplayType.MULTI_LEVEL_COLLECTIONS ||
                    this.displayType == qn.a.DisplayType.MULTI_LEVEL_TAG;
                return (
          ...
          },
          {
            ...
            value: function () {
              var t = 0,
                e = [
                  qn.a.DisplayType.LIST,
                  qn.a.DisplayType.BOX,
                  qn.a.DisplayType.SWATCH,
                  qn.a.DisplayType.RATING,
                  qn.a.DisplayType.MULTI_LEVEL_TAG,
                ];
              return (
                this.filterItems &&
              ...
              (this.status = t.status),
                ...
                t.inventoryBaseSelectedLocations &&
                  ...
                  (l.a.inventoryBaseSelectedLocations =
                    t.inventoryBaseSelectedLocations)),
                t.filterType == qn.a.FilterType.LOCATION &&
          ...
          },
          {
            ...
            value: function () {
              ...
              var t = [qn.a.FilterType.STOCK],
                ...
                r =
                  this.valueType != qn.a.ValueType.ALL &&
                  (this.sortManualValues ||
                    o.a.getSettingValue("general.sortManualValues")),
                i =
                  this.displayType == qn.a.DisplayType.RANGE &&
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.sortType
                  ? this.sortType
                  : qn.a.SortType.KEY_ASCENDING,
                n = e.split("-")[0],
                r = "key" == n ? "doc_count" : "key";
              this.filterType == qn.a.FilterType.COLLECTION &&
                "key" == n &&
                (n = "label"),
                t &&
                  t.length > 0 &&
                ...
                (e.indexOf("desc") > -1 ||
                  (e.startsWith("alpha") &&
                    (this.filterType == qn.a.FilterType.REVIEW_RATINGS ||
                      this.filterType == qn.a.FilterType.PERCENT_SALE))) &&
                  t.reverse();
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              (t = this.prepareFilterOptionData(t)),
                ta(ra(o.prototype), "setData", this).call(this, t);
            },
          },
        ]) && Xo(e.prototype, n),
        r && Xo(e, r),
        ...
        (n = [
          {
            key: "getBlockContentTemplate",
            value: function () {
              return this.selectType == qn.a.SelectType.MULTIPLE &&
        ...
        (n = [
          {
            ...
            value: function () {
              (this.clearButton = new _r(
                this.filterTreeType,
                _r.ClearType.CLEAR_SINGLE_VALUE
              )),
                this.addComponent(this.clearButton);
            },
          },
              ...
              Settings.getSettingValue("general.separateRefineByFromFilter") &&
                (i()(s.a.filterRefineByHorizontal).length > 0
                  ...
                  : i()(s.a.filterRefineByVertical).length > 0 &&
                    (this.filterTreeType = vr.FilterTreeType.VERTICAL)),
                (this.clearAllButton = new _r(
                  this.filterTreeType,
                  _r.ClearType.CLEAR_ALL
                )),
                ...
                e.forEach(function (e) {
                  ...
                  if ((o && !Array.isArray(i) && (i = [i]), n && i)) {
                    var a =
                      n.displayType ==
                        qn.a.DisplayType.MULTI_LEVEL_COLLECTIONS ||
                      n.displayType == qn.a.DisplayType.MULTI_LEVEL_TAG;
                    if (n.displayType == qn.a.DisplayType.RANGE) {
                      ...
                      var u =
                        ...
                        (n.displayType == qn.a.DisplayType.MULTI_LEVEL_TAG &&
                          n.selectType == qn.a.SelectType.SINGLE);
        ...
        (n = [
          {
            key: "init",
            value: function () {
              Qa(Xa(s.prototype), "init", this).call(this),
                (this.requestInstantly =
                  this.filterTreeType == vr.FilterTreeType.VERTICAL ||
                  o.a.getSettingValue("general.requestInstantly"));
            },
          ...
          },
          {
            key: "render",
            value: function () {
              Qa(Xa(s.prototype), "render", this).call(this),
                this.$element.addClass(
          ...
          },
          {
            ...
            value: function (t) {
              if (
                ((t = this.prepareFilterOptionData(t)),
                Qa(Xa(s.prototype), "setData", this).call(this, t),
              ...
              if (
                ...
                (this.isPriceFilter =
                  t.filterType == qn.a.FilterType.PRICE ||
                  t.filterType == qn.a.FilterType.VARIANTS_PRICE),
                ...
                Array.isArray(t.values) && t.values.length > 1
                  ? ((this.hideInputElement = !0),
                    ...
                    this.setCurrentValues(),
                    this.setDisplayStyle())
                  : (this.status = qn.a.Status.DISABLED);
            },
          },
        ]) && Ya(e.prototype, n),
        r && Ya(e, r),
    ...
    function il(t, e) {
      return !e || ("object" !== el(e) && "function" != typeof e)
        ? (function (t) {
            if (void 0 === t)
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
    ...
    function ul(t, e) {
      return !e || ("object" !== ll(e) && "function" != typeof e)
        ? (function (t) {
            if (void 0 === t)
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
          ...
          },
          {
            ...
            value: function () {
              ...
              switch (this.displayTypeItem) {
                case qn.a.DisplayType.LIST:
                  t =
                    this.selectType == qn.a.SelectType.SINGLE
                      ? N.a.filterOptionItemListSingleList
                      : N.a.filterOptionItemListMultipleList;
                  break;
                case qn.a.DisplayType.BOX:
        ...
        (n = [
          ...
          },
          {
            ...
            value: function () {
              if (this.refineBy) {
                var t =
                  this.refineBy.filterTreeType == vr.FilterTreeType.VERTICAL
            ...
            value: function (t) {
              ...
              this.collectionId == l.a.collectionId
                ...
                o.a.getSettingValue("general.showRefineBy") &&
                  ((this.refineBy = new $a(this.filterTreeType)),
              ...
              t.forEach(function (t) {
                if (
                  (Array.isArray(e) &&
                    ...
                    t.selectType == qn.a.SelectType.MULTIPLE &&
                    (t.displayType = qn.a.DisplayType.RANGE),
                  t.filterType == qn.a.FilterType.MULTI_LEVEL_TAG)
                ) {
                  switch (t.displayType) {
                    case qn.a.DisplayType.LIST:
                ...
                ((u.a.isVendorPage() &&
                  t.filterType == qn.a.FilterType.VENDOR) ||
                  (u.a.isTypePage() &&
                    t.filterType == qn.a.FilterType.PRODUCT_TYPE)) &&
                  (t.status = qn.a.Status.DISABLED),
                  t.displayType == qn.a.DisplayType.SUB_CATEGORY &&
                    (t.status = qn.a.Status.DISABLED);
              });
            },
          },
        ...
        (n = [
          {
            key: "init",
            value: function () {
              Tl(wl(c.prototype), "init", this).call(this),
          ...
          },
          {
            ...
            value: function () {
              var t = this;
              if (
                (Tl(wl(c.prototype), "render", this).call(this),
          ...
          },
          {
            ...
            value: function () {
              var t = this;
              Tl(wl(c.prototype), "bindEvents", this).call(this),
                this.$element &&
                  u.a.isMobile() &&
                  (this.$element
        ...
        (n = [
          {
            key: "init",
            value: function () {
              El(Ll(l.prototype), "init", this).call(this),
                i()(this.idSelector).length > 0 &&
                  (i()(this.idSelector)
                    .addClass("boost-pfs-filter-tree-mobile-style2")
                    .addClass("boost-pfs-filter-tree-mobile-sticky")
        ...
        (n = [
          {
            key: "init",
            value: function () {
              Dl(jl(l.prototype), "init", this).call(this),
                i()(this.idSelector).length > 0 &&
                  (i()(this.idSelector)
          ...
          },
          {
            ...
            value: function () {
              var t = this;
              Dl(jl(l.prototype), "render", this).call(this),
                this.$element &&
                  u.a.isMobile() &&
                  this.filterOptions.forEach(function (e) {
          ...
          },
          {
            key: "bindEvents",
            value: function () {
              Dl(jl(l.prototype), "bindEvents", this).call(this),
                this.mathHeightToolbarHeader();
            },
          },
          {
        ...
        (n = [
          {
            key: "init",
            value: function () {
              Hl(ql(l.prototype), "init", this).call(this),
                i()(this.idSelector).length > 0 &&
                  (i()(this.idSelector)
                    .addClass("boost-pfs-filter-tree-mobile-style3")
                    .addClass("boost-pfs-filter-tree-mobile-sticky")
          ...
          (n = [
            {
              key: "init",
              value: function () {
                Yl(Zl(c.prototype), "init", this).call(this),
                  i()(this.idSelector).length > 0 &&
                    (i()(this.idSelector)
            ...
            },
            {
              ...
              value: function () {
                var t = this;
                if (
                  (Yl(Zl(c.prototype), "render", this).call(this),
                  this.$element && u.a.isMobile())
                ) {
                  var e = null;
                  this.filterOptions.forEach(function (n) {
            ...
            },
            {
              ...
              value: function () {
                var t = this;
                Yl(Zl(c.prototype), "bindEvents", this).call(this),
                  this.$element &&
                    u.a.isMobile() &&
                    (this.$element
                      .find(this.selector.backButton)
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                this.initInCollectionSearch(),
                  ...
                  (this.filterResult = new Wn()),
                  this.addComponent(this.filterResult),
                  (this.filterLoadingIcon = new fr()),
                  this.addComponent(this.filterLoadingIcon),
                  (this.filterScrollToTop = new br()),
                        ...
                        ((e && this.filterTrees[r].id == e) ||
                          (!e &&
                            this.filterTrees[r].filterTreeType ==
                              vr.FilterTreeType.VERTICAL)) &&
                        ((this.filterMobileButton = new Zn(
                          this.filterTrees[r]
                        )),
                  ...
                  for (var e = this.filterTrees.length, n = 0; n < e; n++)
                    this.filterDesktopButton ||
                      (0 !=
                        ...
                        ((this.filterDesktopButton = new or(
                          this.filterTrees[n]
                        )),
            ...
            },
            {
              ...
              value: function (t) {
                (!u.a.isMobile() &&
                  ...
                  t.filterTreeType != vr.FilterTreeType.VERTICAL ||
            ...
            },
            {
              ...
              value: function () {
                ...
                ("style-off-canvas" === e || "style-expand" === e || c) &&
                  (n.each(function (t, e) {
                    u.a.sticky(
                      i()(e),
                      s.a.endStickyDesktop,
                ...
                if (
                  ...
                  u.a.isMobile() &&
                    o.a.getSettingValue("search.suggestionMobileStyle") !==
                      ds.a.Mobile.SuggestionType.STYLE_2)
                ) {
      ...
      js = {
        inject: function (t) {
          (t.jQ = i.a),
            ...
            (t.InstantSearchApi = ys.default),
            (t.FilterTreeEnum = vr),
            (t.FilterOptionEnum = qn.a),
            (t.InstantSearchEnum = ds.a),
            (t.Filter = as),
            (t.FilterTree = bl),
            (t.FilterStyle = ts),
            (t.FilterTreeStyle2 = _l),
            (t.FilterTreeStyle2Fullwidth = Al),
            (t.FilterTreeStyle3 = Vl),
            (t.FilterTreeStyle3Fullwidth = Gl),
            (t.FilterTreeStyle4 = Xl),
            (t.FilterOption = Qo),
            (t.FilterOptionList = ia),
            (t.FilterOptionBox = pa),
            (t.FilterOptionSwatch = ba),
            (t.FilterOptionMultiLevelCollections = al),
            (t.FilterOptionMultiLevelTag = fl),
            (t.FilterOptionRangeSlider = tl),
            (t.FilterOptionRating = _a),
            (t.FilterOptionSubCategory = Wa),
            (t.FilterApplyButton = Lr),
            (t.FilterClearButton = _r),
            (t.FilterCollapse = Wo),
            (t.FilterScrollbar = io),
            (t.FilterSearchBox = Wi),
            (t.FilterTooltip = Qi),
            (t.FilterViewMore = ji),
            (t.FilterOptionItem = $r),
            (t.FilterOptionItemList = Ur),
            (t.FilterOptionItemBox = Jr),
            (t.FilterOptionItemSwatch = oi),
            (t.FilterOptionItemMultiLevelCollections = So),
            (t.FilterOptionItemSecondLevelCollections = mo),
            (t.FilterOptionItemThirdLevelCollections = bo),
            (t.FilterOptionItemMultiLevelTag = Fo),
            (t.FilterOptionItemSecondLevelTag = Lo),
            (t.FilterOptionItemThirdLevelTag = Ao),
            (t.FilterOptionItemRangeSlider = Ri),
            (t.FilterOptionItemRating = hi),
            (t.FilterOptionItemSubCategory = Ti),
            (t.FilterRefineBy = $a),
            (t.FilterRefineByItem = La),
            (t.FilterLoadingIcon = fr),
            (t.FilterMobileButton = Zn),
            (t.FilterDesktopButton = or),
            (t.FilterScrollToTop = br),
            (t.FilterResult = Wn),
            (t.ProductList = ft),
            (t.ProductListPlaceholder = Ue),
            (t.ProductListSearchNoResult = jn),
            (t.ProductItem = O),
            (t.ProductGridItem = E),
            (t.ProductListItem = F),
            (t.ProductCollageItem = M),
            (t.Breadcrumb = ee),
            ...
            (t.InstantSearchStyle = ms.a),
            (t.InstantSearchResultStyle2 = _s.a),
            (t.InstantSearchStyle3 = h.a),
            (t.InstantSearchNoResult = Cs.a),
            (t.InstantSearchOnclick = ks.a),
            (t.InstantSearchResultBlock = Es.a),
            (t.InstantSearchResultBlockDym = Rs.a),
            (t.InstantSearchResultBlockEmpty = Is.a),
            (t.InstantSearchResultBlockLoading = Ls.a),
            (t.InstantSearchResultBlockViewAll = As.a),
            (t.InstantSearchResultItem = xs.a),
            (t.InstantSearchResultItemCollection = Fs.a),
            (t.InstantSearchResultItemPage = Ds.a),
            (t.InstantSearchResultItemPopular = Bs.a),
            (t.InstantSearchResultItemProduct = y.a),
            (t.InstantSearchResultRedirect = $s.a),
            (t.SearchAutoComplete = gs.a);
        },
      };
    function Vs(t) {
      return (Vs =
    ...
    var r = n(0),
      ...
      o = {
        ...
        search: {
          ...
          resultEmpty:
            'Sorry, nothing found for "{{ terms }}". Check out other items in our store.',
    ...
    var y = null,
      ...
      C = function (t) {
        ...
        (o.a.defaultSorting =
          "" != n
            ? n
            : a.a.getSettingValue("general.filterEverywhereDefaultSorting")),
      ...
      k = {
        BoostPFSFilterCallback: function (t) {
          ...
          // t.products.sort((a, b) => b.price_max - a.price_max);
          // t.products.forEach(async (p) => {
          // });
          // fetch(window.Shopify.routes.root + "products.json").then(
          //   async (responseed) => {
          //     responseed = await responseed.json();
          //     console.log(responseed, "core.js responseed json");
          //   }
          // );
          ...
          },
          {
            ...
            value: function () {
              ...
              if ("left" == this.suggestionDirection) {
                ...
                a.a.isMobile()
                  ? this.$wrapper.css({ top: l, right: "10px", left: "10px" })
                  : this.$wrapper.css({ top: l, left: s });
                var y = function () {
                    f < h
                ...
                (l = r + "px"),
                  (c = window.innerWidth - n.right + "px"),
                  a.a.isMobile()
                    ? this.$wrapper.css({ top: l, right: "10px", left: "10px" })
                    : this.$wrapper.css({ top: l, right: c }),
                  (y = function () {
                    t.$instantSearchResult.css({
                      top: "0px",
                      right: "0px",
          ...
          },
          {
            ...
            value: function (t) {
              ...
              t.forEach(function (t) {
                ...
                void 0 === i && (i = ""),
                  i.includes("products") || "view-all" == i || "empty" == i
                    ? n.append(t)
                    : r.append(t);
              }),
                "" == n.html().trim()
                  ? r.addClass(l.a.searchSuggestion + "-no-products")
                  : r.removeClass(l.a.searchSuggestion + "-no-products"),
                "" == r.html().trim()
                  ? n.addClass(l.a.searchSuggestion + "-no-others")
                  : n.removeClass(l.a.searchSuggestion + "-no-others"),
