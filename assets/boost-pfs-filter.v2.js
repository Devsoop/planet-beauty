...
if (
  (typeof lazySizes !== "function" && typeof lazySizes !== "object") ||
...
(function () {
  ...
  function prepareShopifyData(data) {
    ...
    // console.log(!data.available.available_locations);
    ...
    if (Utils.getParam("variant") !== null && Utils.getParam("variant") != "") {
      ...
      for (var i = 0; i < data["variants"].length; i++) {
        if (data["variants"][i].available) {
          ...
          // console.log(data['variants'][i].available_locations);
          break;
        }
      }
    }
  ...
  ProductGridItem.prototype.compileTemplate = function (data) {
    ...
    itemHtml = itemHtml.replace(/{{itemVariantID}}/g, firstVariant.id);
  ...
  ProductSorting.prototype.bindEvents = function () {
    ...
    jQ(".boost-pfs-filter-filter-dropdown a").click(function (e) {
      ...
      if (jQ(this).data("sort") === "best-selling") {
        const CurrentRoute = window.location.pathname;
        if (CurrentRoute != "/collections/bestseller") {
          localStorage.setItem("PreviousRoute", CurrentRoute);
        }

        window.location = "https://www.planetbeauty.com/collections/bestseller";
      } else {
        const PreviousRoute = localStorage.getItem("PreviousRoute");
        if (
          window.location.pathname == "/collections/bestseller" &&
          PreviousRoute
        ) {
          const BASE = "https://www.planetbeauty.com" + PreviousRoute;
          const sortBy = jQ(this).data("sort");
          const URL =
            sortBy && sortBy === "title-ascending"
              ? BASE
              : BASE + "?sort=" + sortBy;
